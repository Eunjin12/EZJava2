...
public class RootController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		ObservableList phoneList = FXCollections.observableArrayList(
				new Phone("°¶·°½ÃS1", "phone01.jpg"),
				new Phone("°¶·°½ÃS2", "phone02.jpg"),
				new Phone("°¶·°½ÃS3", "phone03.jpg"),
				new Phone("°¶·°½ÃS4", "phone04.jpg"),
				new Phone("°¶·°½ÃS5", "phone05.jpg"),
				new Phone("°¶·°½ÃS6", "phone06.jpg"),
				new Phone("°¶·°½ÃS7", "phone07.jpg")
			);
