/*
 * try, catch에서 finally는 옵션으로 try나 catch문이 실행 된 후 
 * 최종적으로 항상 실행되는 블럭이다.
 * 정상적으로 try문이 실행되거나 예외가 발생하여 catch문이 실행되어도 최종적으로 항상 실행된다.
 * finally 블럭에는 반드시 실행되어야 할 처리 루틴을 기술한다.
 */
package runtimeexceptions;

public class TryCatchFinallyRuntimeExceptionExample3 {
