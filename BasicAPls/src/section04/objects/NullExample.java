 ...
 * - null이면 NullPointerException 예외가 발생하므로 null이면 반두시 예외처리를 해야 한다.
...
public class NullExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("isNull(s1): " + Objects.nonNull(s1)); // true
		System.out.println("isNull(s2): " + Objects.nonNull(s2)); // false
